...
var event_offsetX = event.offsetX ? event.offsetX : event.layerX;
var event_offsetY = event.offsetY ? event.offsetY : event.layerY;
var event_x = event.x ? event.x : event.clientX;
var event_y = event.y ? event.y : event.clientY;
...
module.exports.GitGraphTemplate = Template;
